      ...
      <li className="mb-10 ml-4">
        ...
        <p className="flex flex-wrap gap-4 flex-row items-center justify-start text-xs md:text-sm">
          ...
          <p className="my-1 text-xl font-bold leading-none text-stone-500">
            <span className="text-lg font-semibold text-[#001b5e]">Tools: </span>
            {item.tools}
          </p>
        </p>
        <h3 className="text-lg font-semibold text-[#001b5e]">Responsive behaviour: <span className="my-1 text-xl font-bold leading-none text-stone-500"> {item.responsive}</span></h3>
